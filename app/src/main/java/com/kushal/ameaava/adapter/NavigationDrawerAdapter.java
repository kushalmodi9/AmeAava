...
/**
 * Created by Kushal on 03-08-2015.
 */
...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    public NavigationDrawerAdapter(String Titles[], int Icons[], String Name, String Email, Context passedContext){ // MyAdapter Constructor with titles and icons parameter
